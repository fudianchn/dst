...
local function checka_a11(self,a_a11) local c = 0 if a_a11 then c=1 end self.inst.checka_a11:set(c) end
local function checka_a12(self,a_a12) local c = 0 if a_a12 then c=1 end self.inst.checka_a12:set(c) end
local function checka_a13(self,a_a13) local c = 0 if a_a13 then c=1 end self.inst.checka_a13:set(c) end
local function checka_a14(self,a_a14) local c = 0 if a_a14 then c=1 end self.inst.checka_a14:set(c) end
local function checka_a15(self,a_a15) local c = 0 if a_a15 then c=1 end self.inst.checka_a15:set(c) end
local function checka_a16(self,a_a16) local c = 0 if a_a16 then c=1 end self.inst.checka_a16:set(c) end
local function checka_a17(self,a_a17) local c = 0 if a_a17 then c=1 end self.inst.checka_a17:set(c) end
local function checka_a18(self,a_a18) local c = 0 if a_a18 then c=1 end self.inst.checka_a18:set(c) end
local function checka_a19(self,a_a19) local c = 0 if a_a19 then c=1 end self.inst.checka_a19:set(c) end
local function checka_a20(self,a_a20) local c = 0 if a_a20 then c=1 end self.inst.checka_a20:set(c) end
local function checka_a21(self,a_a21) local c = 0 if a_a21 then c=1 end self.inst.checka_a21:set(c) end
local function checka_a22(self,a_a22) local c = 0 if a_a22 then c=1 end self.inst.checka_a22:set(c) end
local function checka_a23(self,a_a23) local c = 0 if a_a23 then c=1 end self.inst.checka_a23:set(c) end
local function checka_a24(self,a_a24) local c = 0 if a_a24 then c=1 end self.inst.checka_a24:set(c) end
local function checka_a25(self,a_a25) local c = 0 if a_a25 then c=1 end self.inst.checka_a25:set(c) end
local function checka_a26(self,a_a26) local c = 0 if a_a26 then c=1 end self.inst.checka_a26:set(c) end
local function checka_a27(self,a_a27) local c = 0 if a_a27 then c=1 end self.inst.checka_a27:set(c) end
local function checka_a28(self,a_a28) local c = 0 if a_a28 then c=1 end self.inst.checka_a28:set(c) end
local function checka_a29(self,a_a29) local c = 0 if a_a29 then c=1 end self.inst.checka_a29:set(c) end
local function checka_a30(self,a_a30) local c = 0 if a_a30 then c=1 end self.inst.checka_a30:set(c) end
local function checka_a31(self,a_a31) local c = 0 if a_a31 then c=1 end self.inst.checka_a31:set(c) end
local function checka_a32(self,a_a32) local c = 0 if a_a32 then c=1 end self.inst.checka_a32:set(c) end
local function checka_a33(self,a_a33) local c = 0 if a_a33 then c=1 end self.inst.checka_a33:set(c) end
local function checka_a34(self,a_a34) local c = 0 if a_a34 then c=1 end self.inst.checka_a34:set(c) end
local function checka_a35(self,a_a35) local c = 0 if a_a35 then c=1 end self.inst.checka_a35:set(c) end
local function checka_a36(self,a_a36) local c = 0 if a_a36 then c=1 end self.inst.checka_a36:set(c) end
local function checka_a37(self,a_a37) local c = 0 if a_a37 then c=1 end self.inst.checka_a37:set(c) end
local function checka_a38(self,a_a38) local c = 0 if a_a38 then c=1 end self.inst.checka_a38:set(c) end
local function checka_a39(self,a_a39) local c = 0 if a_a39 then c=1 end self.inst.checka_a39:set(c) end
local function checka_a40(self,a_a40) local c = 0 if a_a40 then c=1 end self.inst.checka_a40:set(c) end
...
local function currenta_a11amount(self,a_a11amount) self.inst.currenta_a11amount:set(a_a11amount) end
local function currenta_a12amount(self,a_a12amount) self.inst.currenta_a12amount:set(a_a12amount) end
local function currenta_a13amount(self,a_a13amount) self.inst.currenta_a13amount:set(a_a13amount) end
local function currenta_a14amount(self,a_a14amount) self.inst.currenta_a14amount:set(a_a14amount) end
local function currenta_a15amount(self,a_a15amount) self.inst.currenta_a15amount:set(a_a15amount) end
local function currenta_a16amount(self,a_a16amount) self.inst.currenta_a16amount:set(a_a16amount) end
local function currenta_a17amount(self,a_a17amount) self.inst.currenta_a17amount:set(a_a17amount) end
local function currenta_a18amount(self,a_a18amount) self.inst.currenta_a18amount:set(a_a18amount) end
local function currenta_a19amount(self,a_a19amount) self.inst.currenta_a19amount:set(a_a19amount) end
local function currenta_a20amount(self,a_a20amount) self.inst.currenta_a20amount:set(a_a20amount) end
local function currenta_a21amount(self,a_a21amount) self.inst.currenta_a21amount:set(a_a21amount) end
local function currenta_a22amount(self,a_a22amount) self.inst.currenta_a22amount:set(a_a22amount) end
local function currenta_a23amount(self,a_a23amount) self.inst.currenta_a23amount:set(a_a23amount) end
local function currenta_a24amount(self,a_a24amount) self.inst.currenta_a24amount:set(a_a24amount) end
local function currenta_a25amount(self,a_a25amount) self.inst.currenta_a25amount:set(a_a25amount) end
local function currenta_a26amount(self,a_a26amount) self.inst.currenta_a26amount:set(a_a26amount) end
local function currenta_a27amount(self,a_a27amount) self.inst.currenta_a27amount:set(a_a27amount) end
local function currenta_a28amount(self,a_a28amount) self.inst.currenta_a28amount:set(a_a28amount) end
local function currenta_a29amount(self,a_a29amount) self.inst.currenta_a29amount:set(a_a29amount) end
local function currenta_a30amount(self,a_a30amount) self.inst.currenta_a30amount:set(a_a30amount) end
local function currenta_a31amount(self,a_a31amount) self.inst.currenta_a31amount:set(a_a31amount) end
local function currenta_a32amount(self,a_a32amount) self.inst.currenta_a32amount:set(a_a32amount) end
local function currenta_a33amount(self,a_a33amount) self.inst.currenta_a33amount:set(a_a33amount) end
local function currenta_a34amount(self,a_a34amount) self.inst.currenta_a34amount:set(a_a34amount) end
local function currenta_a35amount(self,a_a35amount) self.inst.currenta_a35amount:set(a_a35amount) end
local function currenta_a36amount(self,a_a36amount) self.inst.currenta_a36amount:set(a_a36amount) end
local function currenta_a37amount(self,a_a37amount) self.inst.currenta_a37amount:set(a_a37amount) end
local function currenta_a38amount(self,a_a38amount) self.inst.currenta_a38amount:set(a_a38amount) end
local function currenta_a39amount(self,a_a39amount) self.inst.currenta_a39amount:set(a_a39amount) end
local function currenta_a40amount(self,a_a40amount) self.inst.currenta_a40amount:set(a_a40amount) end
...
--================================================
    ...
    a_a11amount = currenta_a11amount,
    a_a12amount = currenta_a12amount,
    a_a13amount = currenta_a13amount,
    a_a14amount = currenta_a14amount,
    a_a15amount = currenta_a15amount,
    a_a16amount = currenta_a16amount,
    a_a17amount = currenta_a17amount,
    a_a18amount = currenta_a18amount,
    a_a19amount = currenta_a19amount,
    a_a20amount = currenta_a20amount,
    a_a21amount = currenta_a21amount,
    a_a22amount = currenta_a22amount,
    a_a23amount = currenta_a23amount,
    a_a24amount = currenta_a24amount,
    a_a25amount = currenta_a25amount,
    a_a26amount = currenta_a26amount,
    a_a27amount = currenta_a27amount,
    a_a28amount = currenta_a28amount,
    a_a29amount = currenta_a29amount,
    a_a30amount = currenta_a30amount,
    a_a31amount = currenta_a31amount,
    a_a32amount = currenta_a32amount,
    a_a33amount = currenta_a33amount,
    a_a34amount = currenta_a34amount,
    a_a35amount = currenta_a35amount,
    a_a36amount = currenta_a36amount,
    a_a37amount = currenta_a37amount,
    a_a38amount = currenta_a38amount,
    a_a39amount = currenta_a39amount,
    a_a40amount = currenta_a40amount,
...
function allachivevent_c:OnSave()
    local data = {
        ...
        a_a11amount = self.a_a11amount,
        a_a12amount = self.a_a12amount,
        a_a13amount = self.a_a13amount,
        a_a14amount = self.a_a14amount,
        a_a15amount = self.a_a15amount,
        a_a16amount = self.a_a16amount,
        a_a17amount = self.a_a17amount,
        a_a18amount = self.a_a18amount,
        a_a19amount = self.a_a19amount,
        a_a20amount = self.a_a20amount,
        a_a21amount = self.a_a21amount,
        a_a22amount = self.a_a22amount,
        a_a23amount = self.a_a23amount,
        a_a24amount = self.a_a24amount,
        a_a25amount = self.a_a25amount,
        a_a26amount = self.a_a26amount,
        a_a27amount = self.a_a27amount,
        a_a28amount = self.a_a28amount,
        a_a29amount = self.a_a29amount,
        a_a30amount = self.a_a30amount,
        a_a31amount = self.a_a31amount,
        a_a32amount = self.a_a32amount,
        a_a33amount = self.a_a33amount,
        a_a34amount = self.a_a34amount,
        a_a35amount = self.a_a35amount,
        a_a36amount = self.a_a36amount,
        a_a37amount = self.a_a37amount,
        a_a38amount = self.a_a38amount,
        a_a39amount = self.a_a39amount,
        a_a40amount = self.a_a40amount,
...
function allachivevent_c:OnLoad(data)
    ...
    self.a_a11 = data.a_a11 or false
    self.a_a12 = data.a_a12 or false
    self.a_a13 = data.a_a13 or false
    self.a_a14 = data.a_a14 or false
    self.a_a15 = data.a_a15 or false
    self.a_a16 = data.a_a16 or false
    self.a_a17 = data.a_a17 or false
    self.a_a18 = data.a_a18 or false
    self.a_a19 = data.a_a19 or false
    self.a_a20 = data.a_a20 or false
    self.a_a21 = data.a_a21 or false
    self.a_a22 = data.a_a22 or false
    self.a_a23 = data.a_a23 or false
    self.a_a24 = data.a_a24 or false
    self.a_a25 = data.a_a25 or false
    self.a_a26 = data.a_a26 or false
    self.a_a27 = data.a_a27 or false
    self.a_a28 = data.a_a28 or false
    self.a_a29 = data.a_a29 or false
    self.a_a30 = data.a_a30 or false
    self.a_a31 = data.a_a31 or false
    self.a_a32 = data.a_a32 or false
    self.a_a33 = data.a_a33 or false
    self.a_a34 = data.a_a34 or false
    self.a_a35 = data.a_a35 or false
    self.a_a36 = data.a_a36 or false
    self.a_a37 = data.a_a37 or false
    self.a_a38 = data.a_a38 or false
    self.a_a39 = data.a_a39 or false
    self.a_a40 = data.a_a40 or false
    ...
    self.a_a11amount = data.a_a11amount or 0
    self.a_a12amount = data.a_a12amount or 0
    self.a_a13amount = data.a_a13amount or 0
    self.a_a14amount = data.a_a14amount or 0
    self.a_a15amount = data.a_a15amount or 0
    self.a_a16amount = data.a_a16amount or 0
    self.a_a17amount = data.a_a17amount or 0
    self.a_a18amount = data.a_a18amount or 0
    self.a_a19amount = data.a_a19amount or 0
    self.a_a20amount = data.a_a20amount or 0
    self.a_a21amount = data.a_a21amount or 0
    self.a_a22amount = data.a_a22amount or 0
    self.a_a23amount = data.a_a23amount or 0
    self.a_a24amount = data.a_a24amount or 0
    self.a_a25amount = data.a_a25amount or 0
    self.a_a26amount = data.a_a26amount or 0
    self.a_a27amount = data.a_a27amount or 0
    self.a_a28amount = data.a_a28amount or 0
    self.a_a29amount = data.a_a29amount or 0
    self.a_a30amount = data.a_a30amount or 0
    self.a_a31amount = data.a_a31amount or 0
    self.a_a32amount = data.a_a32amount or 0
    self.a_a33amount = data.a_a33amount or 0
    self.a_a34amount = data.a_a34amount or 0
    self.a_a35amount = data.a_a35amount or 0
    self.a_a36amount = data.a_a36amount or 0
    self.a_a37amount = data.a_a37amount or 0
    self.a_a38amount = data.a_a38amount or 0
    self.a_a39amount = data.a_a39amount or 0
    self.a_a40amount = data.a_a40amount or 0
...
function allachivevent_c:eatfn(inst)
   ...
   -- local RGB = { 207/255,  27/255,  27/255}
                    self.a_a2amount = self.a_a2amount + 500
                   -- inst.components.talker:Say("Lv"..self.a_a4amount.."  exp+500",nil,nil,nil,nil,RGB)
            ...
            --吃掉50齿轮
            if self.a_snake ~= true and food.prefab == "gears"  then
...
function allachivevent_c:onkilledother(inst)
    inst:ListenForEvent("killed", function(inst, data)
        ...
        --击杀6只秃鹫
        if victim and victim.prefab == "buzzard" and self.a_a9 ~= true then
            self.a_a9amount = self.a_a9amount + 1
            if self.a_a9amount >= allachiv_eventdata["a_a9"] then
                self.a_a9 = true
                self:seffc(inst, "a_a9")
            end
        end
        --击杀11只缀食者
        if victim and victim.prefab == "slurper" and self.a_a10 ~= true then
            self.a_a10amount = self.a_a10amount + 1
            if self.a_a10amount >= allachiv_eventdata["a_a10"] then
                self.a_a10 = true
                self:seffc(inst, "a_a10")
            end
        end
...
--
function allachivevent_c:sanitycheck(inst)
    inst:DoPeriodicTask(1, function()
--装备缀食者
		local item = inst.components.inventory:GetEquippedItem(EQUIPSLOTS.HEAD)
        if item ~= nil and item.prefab == "slurper" and self.a_a11 ~= true and inst.components.health.currenthealth > 0 then
			self.a_a11amount = self.a_a11amount + 1
            if self.a_a11amount >= allachiv_eventdata["a_a11"] then
                self.a_a11 = true
                self:seffc(inst, "a_a11")
            end
        end
--装备独奏乐器
		local item2 = inst.components.inventory:GetEquippedItem(EQUIPSLOTS.BODY)
		local item3 = inst.components.inventory:GetEquippedItem(EQUIPSLOTS.BACK)
        if ( (item2 ~= nil and item2.prefab == "onemanband") or ( item3 ~= nil and item3.prefab == "onemanband") ) and   self.a_a12 ~= true and inst.components.health.currenthealth > 0 then
			self.a_a12amount = self.a_a12amount + 1
            if self.a_a12amount >= allachiv_eventdata["a_a12"] then
                self.a_a12 = true
                self:seffc(inst, "a_a12")
            end
        end
...
--
function allachivevent_c:onpick(inst)
    inst:ListenForEvent("picksomething", function(inst, data)
        --采集仙人掌
        if data.object and data.object.components.pickable and not data.object.components.trader and ( data.object.prefab  == "cactus" or data.object.prefab  == "oasis_cactus" )then
        	if self.a_a22 ~= true  then
               self.a_a22amount = self.a_a22amount + 1
                if self.a_a22amount >= allachiv_eventdata["a_a22"] then
                    self.a_a22 = true
                    self:seffc(inst, "a_a22")
                end
        	end
        end
...
--
function allachivevent_c:onbuild(inst)

    --制造
    inst:ListenForEvent("builditem", function(inst,data)
    	--制造噩梦燃料
        if self.a_a18 ~= true and  data and data.recipe.product  == "nightmarefuel"   then
            self.a_a18amount = self.a_a18amount + 1
            if self.a_a18amount >= allachiv_eventdata["a_a18"] then
                self.a_a18 = true
                self:seffc(inst, "a_a18")
            end
        end
    	--制造南瓜灯
        if self.a_a19 ~= true and  data and data.recipe.product  == "pumpkin_lantern"   then
            self.a_a19amount = self.a_a19amount + 1
            if self.a_a19amount >= allachiv_eventdata["a_a19"] then
                self.a_a19 = true
                self:seffc(inst, "a_a19")
            end
        end
    	--制造大理石盔甲
        if self.a_a13 ~= true and  data and data.recipe.product  == "armormarble"   then
            self.a_a13amount = self.a_a13amount + 1
            if self.a_a13amount >= allachiv_eventdata["a_a13"] then
                self.a_a13 = true
                self:seffc(inst, "a_a13")
            end
        end
    	--制造远古王冠
        if self.a_a14 ~= true and  data and data.recipe.product  == "ruinshat"   then
            self.a_a14amount = self.a_a14amount + 1
            if self.a_a14amount >= allachiv_eventdata["a_a14"] then
                self.a_a14 = true
                self:seffc(inst, "a_a14")
            end
        end
    	--制造远古盔甲
        if self.a_a15 ~= true and  data and data.recipe.product  == "armorruins"   then
            self.a_a15amount = self.a_a15amount + 1
            if self.a_a15amount >= allachiv_eventdata["a_a15"] then
                self.a_a15 = true
                self:seffc(inst, "a_a15")
            end
        end
    	--制造铥矿棒
        if self.a_a16 ~= true and  data and data.recipe.product  == "ruins_bat"   then
            self.a_a16amount = self.a_a16amount + 1
            if self.a_a16amount >= allachiv_eventdata["a_a16"] then
                self.a_a16 = true
                self:seffc(inst, "a_a16")
            end
        end    	--制造火药
        if self.a_a17 ~= true and  data and data.recipe.product  == "gunpowder"   then
            self.a_a17amount = self.a_a17amount + 1
            if self.a_a17amount >= allachiv_eventdata["a_a17"] then
                self.a_a17 = true
                self:seffc(inst, "a_a17")
            end
        end
    	--制造治疗药膏
        if self.a_a20 ~= true and  data and data.recipe.product  == "healingsalve"   then
            self.a_a20amount = self.a_a20amount + 1
            if self.a_a20amount >= allachiv_eventdata["a_a20"] then
                self.a_a20 = true
                self:seffc(inst, "a_a20")
            end
        end
    	--制造蜂蜜绷带
        if self.a_a21 ~= true and  data and data.recipe.product  == "bandage"   then
            self.a_a21amount = self.a_a21amount + 1
            if self.a_a21amount >= allachiv_eventdata["a_a21"] then
                self.a_a21 = true
                self:seffc(inst, "a_a21")
            end
        end
