...
local uiachievement_c = Class(Widget, function(self, owner)
	Widget._ctor(self, "uiachievement_c")
	self.owner = owner
...
function uiachievement_c:OnUpdate(dt)
...
function uiachievement_c:build()
...
function uiachievement_c:coinbuild()
...
function uiachievement_c:loadlist()
	...
	self.achivlist = {
        ...
        {name = "a_bisque",check = self.owner.checka_bisque:value(),current = self.owner.currenta_bisqueamount:value(),},
        {name = "a_surfnturf",check = self.owner.checka_surfnturf:value(),current = self.owner.currenta_surfnturfamount:value(),},
        ...
        {name = "a_twister",check = self.owner.checka_twister:value(),current = nil,},
        {name = "a_snake",check = self.owner.checka_snake:value(),current = self.owner.currenta_snakeamount:value(),},
        {name = "a_snake_poison",check = self.owner.checka_snake_poison:value(),current = self.owner.currenta_snake_poisonamount:value(),},
        {name = "a_crocodog",check = self.owner.checka_crocodog:value(),current = self.owner.currenta_crocodogamount:value(),},
        {name = "a_poisoncrocodog",check = self.owner.checka_poisoncrocodog:value(),current = self.owner.currenta_poisoncrocodogamount:value(),},
        {name = "a_watercrocodog",check = self.owner.checka_watercrocodog:value(),current = self.owner.currenta_watercrocodogamount:value(),},
        {name = "a_coffee",check = self.owner.checka_coffee:value(),current = self.owner.currenta_coffeeamount:value(),},
...
function uiachievement_c:loadcoinlist()
	self.coinlist = {
		{
			name = "hungerup",
