...
local function modify(self)
    local btn_profile = {
        {name = "qingjiu", title = "清酒", fn = function()
            self.qingjiu_button:Disable()
            GLOBAL.c_connect("dst.fudianchn.com", 11000)
        end},
        {name = "ronglu", title = "熔炉", fn = function()
            self.ronglu_button:Disable()
            GLOBAL.c_connect("dst.fudianchn.com", 11010)
        end}
    }
