...
local function StartingInventory(inst, player)
    ...
    --配置初始物品--
    giveItemToPlayer(startInventory, 10, "meat_dried") --肉干
    giveItemToPlayer(startInventory, 20, "cutgrass") --给20个草
    giveItemToPlayer(startInventory, 20, "twigs") --给20个树枝
    giveItemToPlayer(startInventory, 20, "log") --给20个木头
    giveItemToPlayer(startInventory, 20, "flint") --给20个燧石
    giveItemToPlayer(startInventory, 20, "rocks") --给20个岩石
    giveItemToPlayer(startInventory, 20, "nitre") --给20个硝石
    giveItemToPlayer(startInventory, 2, "goldnugget") --给2个金块
    --    giveItemToPlayer(startInventory, 2, "gears") --给2个齿轮
